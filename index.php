    ...
    <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
      <div class="wrap-login100 p-l-55 p-r-55 p-b-54">
        <form class="login100-form validate-form" id="login-form">
         ...
         &copy; Sr Leonella Consolata Medical College 2022.
      </div>
    </div>
  </div>
     ...
     function attemptLogin(){
          ...
          $.post('applicant-dashboard/core/core.php',
          {
            data:json
             ...
             if (data === 'empty') {
               document.getElementById("notify").innerHTML="<span class='alert alert-danger'>Ooops! email "+username+" is not registered. \nPlease check whether it is your correct email.\n If its correct, create an account then login. \nThanks</span>";
