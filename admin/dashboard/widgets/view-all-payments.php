...
<div class="card">
  ...
  <b style="float:right;">
  <button class="btn btn-info"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button>
  <button class="btn btn-danger"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button>
  </b>
  <b style="float:right;">
  <input type="text" name="search_app" class="form-control" placeholder="Enter # to serach " onkeyup="searchAppFunction()" id="serach_app"></b>
  </h5>
  </div>
